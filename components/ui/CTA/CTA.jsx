          ...
          <div className="relative z-10">
            <div className="max-w-xl mx-auto text-center">
              <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                Unleash the Power of Task manager using Efficsync AI
              </h2>
              <p className="mt-5 text-gray-300">
              Efficsync leverages advanced AI capabilities to provide
                personalized task management solutions, allowing you to create
                customized workflows and optimize task assignments for each team
                member, resulting in increased efficiency and productivity.
              </p>
            </div>
